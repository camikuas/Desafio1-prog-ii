...
public class PerfilJugador : ScriptableObject
{
    ...
    public int ExperienciaProximoNivel { get => experienceToNextLevel; set => experienceToNextLevel = value; }

    [SerializeField]
    [Tooltip("Como aumenta la experiencia nivel a nivel")]
    [Range(10, 2000)]
    private int scaleExperience;
    public int EscalarExperiencia { get => scaleExperience; set => scaleExperience = value; }
    ...
    public int Experiencia { get => currentExperience; set => currentExperience = value; }
